...
export default function RegistrationFormArabic() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] py-4 px-2 sm:px-6 lg:px-8 font-['Alexandria',sans-serif]">
      <div className="max-w-[800px] mx-auto bg-white shadow-sm overflow-hidden rounded-md border border-gray-200">
        ...
        <div className="p-4 sm:p-8">
          ...
          <div className="text-center mb-6">
            ...
            <div className="bg-[#f8f9fa] p-4 rounded-lg border border-gray-100">
              <p className="text-[15px] text-[#444] leading-relaxed">
                ...
                <br />
                <span className="font-bold text-[#222]">مبادرة مخصّصة للأسر الإماراتية</span>
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 border border-gray-200 rounded-md overflow-hidden">
            ...
            >
              <span className="font-bold text-[#222]">تعليمات التسجيل</span>
              <svg 
            ...
            {showInstructions && (
              <div className="p-4 border-t border-gray-200 text-[13px] text-[#666] leading-[1.8] bg-white">
                <p className="font-bold mb-2">يرجى قراءة هذه التعليمات قبل البدء بالتسجيل</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Membership Tiers */}
            <div className="mt-8">
              <h2 className="text-[17px] font-bold text-center text-[#222] mb-6">فئات العضوية الممنوحة:</h2>
            ...
            <div className="mt-8 bg-[#f8f9fa] p-5 rounded-lg border border-gray-100">
              <h3 className="font-bold text-[14px] text-[#222] mb-2">المزايا:</h3>
