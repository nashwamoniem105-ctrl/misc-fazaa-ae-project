                ...
                <div className="absolute left-3 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center pointer-events-none">
                  {cardType === 'unknown' && cardNumber.length < 2 ? (
                    ...
                    <div className="flex items-center justify-center">
                      <svg width="38" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.795 15.637l1.09-6.793h1.743l-1.09 6.793h-1.743zm7.802-6.793l-1.68 6.793h-1.636l-0.816-5.266c-0.045-0.264-0.102-0.345-0.306-0.455-0.339-0.183-0.893-0.352-1.385-0.455l0.02 0.09c0.803 0.17 1.583 0.606 1.803 1.776l1.21 6.31h1.765l2.64-6.793h-1.625zm-11.233 6.793l2.254-6.793h1.743l-2.254 6.793h-1.743zm-4.735-6.793c-0.45-0.015-0.88 0.228-1.076 0.612l-3.79 6.181h1.848l0.75-1.226h2.264l0.213 1.226h1.775l-1.554-6.793h-0.43zm-0.02 1.348l0.78 4.456h-1.536l0.756-4.456z" fill="#1A1F71"/>
                        <path d="M8.762 8.844c-0.054-0.32-0.278-0.57-0.584-0.686-0.612-0.23-1.615-0.44-2.51-0.574l0.045 0.25c1.465 0.355 2.508 1.18 2.91 2.278l0.139-1.268z" fill="#F7B600"/>
                      </svg>
                    </div>
                  ) : cardType === 'mastercard' ? (
                    <div className="flex items-center justify-center">
